...
namespace CGALDotNetUnity
{
    ...
    public abstract class tmp : MonoBehaviour
    {
        ...
        protected void AddPoints(string name, Point2d[] points, float size, Color pointColor, Color outlineColor)
        {
            var pointBody = new CircleRenderer();
            pointBody.Orientation = DRAW_ORIENTATION.XY;
            pointBody.Segments = POINT_SEGMENTS;
        ...
        protected void AddPoints(string name, Circle2d[] points, float size, Color pointColor, Color outlineColor)
        {
            var pointBody = new CircleRenderer();
            pointBody.Orientation = DRAW_ORIENTATION.XY;
            pointBody.Segments = POINT_SEGMENTS;
